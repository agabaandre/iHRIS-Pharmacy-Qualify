...
class I2CE_Swiss_PageXMLRelationship extends I2CE_Swiss_Page {

    protected function getArgsHandler() {
		return 'PageXMLRelationship_Args';
    }

    protected function getSampleIDs() {
        if ( !($argsChild = $this->getChild('args',false)) instanceof I2CE_Swiss_PageArgs
             || ! ($rel_obj = $argsChild->getRelationship()) instanceof I2CE_FormRelationship
             || !( $form = $rel_obj->getForm('primary_form')) 
