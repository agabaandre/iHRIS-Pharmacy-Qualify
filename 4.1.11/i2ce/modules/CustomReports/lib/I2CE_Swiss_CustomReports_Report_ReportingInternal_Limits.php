...
*/ 
/** 
* Class I2CE_Swiss_CustomReports_Report_ReportingInternal_Limits
* 
* @access public
*/


class I2CE_Swiss_CustomReports_Report_ReportingInternal_Limits extends I2CE_Swiss_CustomReports_Report_ReportingForm_Field_Limits{
...
//     }
    ...
    protected function ensureLimits() {
        ...
        if (!$this->parent instanceof I2CE_Swiss_CustomReports_Report_ReportingInternal) {
            return false;
        }
