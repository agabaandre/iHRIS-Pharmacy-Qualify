 ...
 * @access public
 */
class I2CE_FormField_DATE_MD extends I2CE_FormField_DB_DATE { 
    public function loadFromXML($node) {
        if (!$node instanceof DOMElement) {
            return;
        }        
        $expected_values = array('day','month');
        $values = array();
        ...
        $this->setValue(I2CE_Date::getDay(   $values['day'], $values['month'] ));        
    }
   ...
   /**
    ...
    public function getFromDB(  $value ) {
        ...
        $value->setType(I2CE_Date::MONTH_DAY);
        return $value;
    }          
    ...
    public function setValue( $value ) {
        ...
        $this->value->setType(I2CE_Date::MONTH_DAY);
    }
