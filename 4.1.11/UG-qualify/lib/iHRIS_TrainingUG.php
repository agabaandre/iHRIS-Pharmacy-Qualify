 ...
 * @access public
 */
class iHRIS_TrainingUG extends iHRIS_Training {
    ...
    public function populate() {
        ...
        if ( $this->trained_outside ) {
            $this->out_qualification = $this->qualification;
        } else {
            $this->in_qualification = $this->qualification;
            $where_data = array(
                    'operator' => 'AND',
                    'operand' => array(
                        array( 
                        ...
                        array(
                            ...
                            'data' => array(
                                'value' =>
                                $this->getField("in_qualification")->getDBValue()
                                )
                            ),
                        )
                    );
