 ...
 * @access public
 */
class iHRIS_PageFormPersonRenew extends iHRIS_PageFormParentPerson {
    ...
    protected function loadHTMLTemplates() {
        ...
        $this->template->appendFileById( "form_person_renew.html", "tbody", "person_form" );
    }
    /**
    ...
    protected function setDisplayData() {
        ...
        $this->template->setDisplayData( "person_form", "person_renew" );
    }
    /**
    ...
    protected function loadObjects() {
        ...
        if ( !$this->isPost() ) {
            ...
            $last = current( $parent->children['person_license'] );
            if ( $last )
