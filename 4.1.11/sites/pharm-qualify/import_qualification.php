		    ...
		    if ( !array_key_exists( $data[iHRIS_QUALIFICATION] , $cache['qualification'] ) )
		     {
                ...
                $qualification_id = find_or_create( $data[iHRIS_QUALIFICATION], "qualification", array(
                            "name" => $data[iHRIS_QUALIFICATION],
                            "academic_level" => $academic_level_id ), true );
