...
$reports = array( 'person_last_reg' => "Registered Pharmacists", 'license_workers' => "Licensed Pharmacists" );


$suffix = date('Y-m-d');
$report_dir = "/var/www/html/reports/pc";
$page_title = "iHRIS: Pharmacy Board";
...
<a name="top"><img src="psu_logo.jpg" alt="" width="62" height="61" id="siteLogo"></a>
<p id="siteName">The Pharmaceutical Society of Uganda and Pharmacy Board</p>
...
exec( "scp -P 20020 -q " . $filename  . " mohhr@hris.health.go.ug:/var/www/html/reports/pc/" );
exec( "scp -P 20020 -q " . $linkname  . " mohhr@hris.health.go.ug:/var/www/html/reports/pc/" );
}
