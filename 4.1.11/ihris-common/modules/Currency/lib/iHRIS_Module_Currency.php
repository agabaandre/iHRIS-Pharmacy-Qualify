...
class iHRIS_Module_Currency extends I2CE_Module {
    ...
    public function pre_upgrade( $old_vers, $new_vers, $new_storage ) {
        if ( I2CE_Validate::checkVersion( $old_vers, '<', '3.2.3' ) ) {
            ...
            I2CE_FormStorage::storeMigrateData( array( "currency" => array( "country" ) ), 
                    $migrate_path );
        }   
    ...
    public function upgrade( $old_vers, $new_vers ) {
        ...
        if ( I2CE_Validate::checkVersion( $old_vers, '<', '3.2.3' ) ) {
            ...
            if ( I2CE_FormStorage::migrateForm( "currency", "entry", $user, $migrate_path, 
