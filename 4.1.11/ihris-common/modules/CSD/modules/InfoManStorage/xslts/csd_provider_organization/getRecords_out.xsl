...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">     
  ...
  <xsl:template match="/">         
    <csd:careServicesRequest xmlns:csd="urn:ihe:iti:csd:2013" xmlns="urn:ihe:iti:csd:2013">             
      <function urn="urn:openhie.org:openinfoman-hwr:stored-function:health_worker_indices_provider_organization">
	<requestParams>                     
	  <xsl:choose>
	    <xsl:when test="/form/@parent_form = 'csd_provider' and /form/@parent_id">
