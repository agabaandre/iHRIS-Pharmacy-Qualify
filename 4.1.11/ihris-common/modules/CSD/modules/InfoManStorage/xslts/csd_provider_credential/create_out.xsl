...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">     
  ...
  <xsl:template match="/">         
    <csd:careServicesRequest xmlns:csd="urn:ihe:iti:csd:2013" xmlns="urn:ihe:iti:csd:2013">             
      <function urn="urn:openhie.org:openinfoman-hwr:stored-function:health_worker_create_credential">
	<requestParams>                     
	  ...
	  <credential>
	    ...
	    <xsl:if test="/form/field[@name='issuing_authority']">
	      <issuingAuthority><xsl:value-of select="/form/field[@name='number']"/></issuingAuthority>
	    </xsl:if>
