...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template match="/">         
    <xsl:for-each select="/csd:CSD/csd:providerDirectory/csd:provider/csd:credential">
      <form name='csd_provider_credential' parent_form='csd_provider'>
	...
	<field name='csd_provider_credential_type' type='MAP'>
	  <value form='csd_provider_credential_type'><xsl:value-of select="concat(csd:codedType/@codingScheme,'@@@',csd:codedType/@code)"/></value>
	</field>
