...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">     
  ...
  <xsl:template match="/">         
    <csd:careServicesRequest xmlns:csd="urn:ihe:iti:csd:2013" xmlns="urn:ihe:iti:csd:2013">             
      <function urn="urn:openhie.org:openinfoman-hwr:stored-function:health_worker_create_provider">
	<requestParams>                     
	  ...
	  <xsl:if test="/form/field[@name='source_directory']">
	    <sourceDirectory><xsl:value-of select="/form/field[@name='source_directory']/text()"/></sourceDirectory>
	  </xsl:if>
	</requestParams>             
      </function>         
