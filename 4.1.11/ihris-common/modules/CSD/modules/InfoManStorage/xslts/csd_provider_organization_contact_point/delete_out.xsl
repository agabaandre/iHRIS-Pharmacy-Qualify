...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">     
  ...
  <xsl:template match="/">         
    <csd:careServicesRequest xmlns:csd="urn:ihe:iti:csd:2013" xmlns="urn:ihe:iti:csd:2013">             
      <function urn='urn:openhie.org:openinfoman-hwr:stored-function:health_worker_delete_org_contact_point'>
	<requestParams>                     
	  ...
	  <organization>
	    ...
	    <contactPoint><xsl:attribute name='position'><xsl:value-of select="substring-after(substring-after(/form/@id,'/'),'/')"/></xsl:attribute></contactPoint>
	  </organization>                                        
	</requestParams>             
      </function>         
