...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template match="/">         
    <xsl:for-each select="/csd:CSD/csd:facilityDirectory/csd:facility/csd:organizations/csd:organization">        
      <form name='csd_facility_organization' parent_form='csd_facility'>
