...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/">
    <form name='mhero_provider_search' id='0'>
	...
	<xsl:for-each select="/csd:CSD/csd:providerDirectory/csd:provider">
          <xsl:variable name='forename'><xsl:value-of select="csd:demographic/csd:name[1]/csd:forename/text()"/></xsl:variable>
          <xsl:variable name='surname'><xsl:value-of select="csd:demographic/csd:name[1]/csd:surname/text()"/></xsl:variable>
