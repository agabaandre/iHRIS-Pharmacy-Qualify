...
class I2CE_Swiss_CSD_RapidPro_Base_Args extends I2CE_Swiss_PageArgs {
    ...
    public function processValues($vals) {
        ...
        $fields = array('api_token','slug','server_host','csd_host','csd_host_user','csd_host_password');
    ...
    protected function getTemplate() {
        return 'swiss_page_csd_rapidpro_args.html';
    }
